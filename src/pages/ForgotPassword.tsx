...
import { Box, Card, CardContent, TextField, Button, Typography, Stack, Link, Alert } from "@mui/material";
    ...
    <Box sx={{
      ...
      <Card sx={{ width: "100%", maxWidth: 440 }}>
        <CardContent sx={{ p: { xs: 3, sm: 4 } }}>
          ...
          {sent ? (
            <Alert severity="success">A reset link has been sent to <b>{email}</b> (mockup).</Alert>
          ) : (
          ...
          <Typography variant="body2" color="text.secondary" align="center" sx={{ mt: 3 }}>
            Remember your password? <Link component={RouterLink} to="/auth/signin" fontWeight={600}>Sign in</Link>
          </Typography>
        </CardContent>
      </Card>
    </Box>
